...
public class DatabaseConnection
{
    public static void CreateDatabase()
    {
        ...
        using (SQLiteConnection connection = new SQLiteConnection(connectionString))
        {
            ...
            string createScheduleQuery = "CREATE TABLE IF NOT EXISTS Schedule (ID INTEGER  PRIMARY KEY AUTOINCREMENT, MovieID INT, HallID INT, SoldSeats INT, StartDate DATETIME, EndDate DATETIME)";
